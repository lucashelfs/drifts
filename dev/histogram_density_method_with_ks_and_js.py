...
class HistogramDensityMethodWithKSAndJS(BatchDetector):
    """
    ...
    def __init__(
        ...
        if divergence == "H":
            ...
            self.distance_function = self._kolmogorov_distance
        else:
    ...
    def _kolmogorov_distance(self, reference_density, test_density):
        """
        Computes Kolmogorov Smirnov p-values to use as distance
        ...
        Returns:
            P-value from Kolmogorov smirnov from reference and test densities

        """
        test_stat = ks_2samp(reference_density, test_density)
        # print(f"p-value: {test_stat.pvalue}")
